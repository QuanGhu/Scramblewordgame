<section class="content">
    <div class="box">
        <div class="box-header with-border">
            <h3 class="box-title">Rekap Pembelian Per Bulan Per Supplier</h3>
        </div>
        <div class="box-body">
            <form method="post" class="form-inline" id="month" action="dashboard/findreportsupplyer">
                  <div class="form-group">
                    <label for="email">Bulan:</label>
                    <select class="form-control" name="supplyer">
                        <?php
                              use App\Model\Query;
